...
public class Translate {
    ...
    public static String translate(String identifier) {
        ...
        for(String s : translatable.keySet()) {
            //if(s.equalsIgnoreCase(identifier)) translated = translatable.get(s);
    ...
    public static void init() {
        ...
        // don't have to change anything in here.

        Main.getInstance().saveResource("lang/en_us.yml", true);
        Main.getInstance().saveResource("lang/de_de.yml", true);
        reload();
